...
mermaid code
flowchart LR
    A[2D images] __> B[SfM]
    B __> C[sparse 3D points]
    B __> D[cameras positions]
    
flowchart LR
    A[cameras positions] __> B[NeRF]
    B __> C[3D reconstruction]
-->
...
![mermaid-diagram-2025-02-06-180555](https://github.com/user-attachments/assets/bda37659-1031-48f3-a613-6bb0e8e9ea8f)

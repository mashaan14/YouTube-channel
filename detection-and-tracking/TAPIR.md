...
Tracking Any Point with per-frame Initialization and temporal Refinement (TAPIR) is a point tracking method. You can find the implementation and followup works on this [repository](https://github.com/google-deepmind/tapnet).
